...
use app\models\NewEngineSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * NewEngineController implements the CRUD actions for Engine model.
 */
class NewEngineController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new NewEngineSearch();
